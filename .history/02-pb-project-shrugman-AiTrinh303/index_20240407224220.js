...
function playGame() {
    ...
    const categoryy = promptSync(chalk.white('Choose a category (movies/books/quotes): '));

    let categoryChoice;
    if (categoryy.toLowerCase() === 'movies') {
     categoryChoice = options.movies;}
    else if (categoryy.toLowerCase() === 'books') {
        categoryChoice = options.books;}
    else{
        categoryChoice = options.quotes;
    }     
