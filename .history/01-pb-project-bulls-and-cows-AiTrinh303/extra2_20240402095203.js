//game has 4 level and when the player play game, he/she can take hint -getHint() need to fix :(((
...
function askForTheRules() {
  let question = prompt(`Do you know the rules of the game ${User} Y/N: `);
  console.clear();
...
//2. Function generate a computer´s random number
...
function getRandomNumber(level) {
  ...
  return numberPick
    ...
    .slice(0, level); // get the first 'level' digits
}

// 2. Function to select the level of the game
