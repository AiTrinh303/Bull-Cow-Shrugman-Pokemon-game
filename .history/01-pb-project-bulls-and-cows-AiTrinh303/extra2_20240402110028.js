...
function playTheGame(level) {
  ...
  while (true) {
    ...
    let { bulls, cows } = evaluateGuess(secretNumber, guess)    // if the user don't find anything then it will print a random cheer message or if the user find a cow or a bull it will print the number of cows and bulls
        if (bulls === 0 && cows === 0) {
          console.log("\n", randomMessage(), "\n");
        }
        console.log(
