//Game has 4 levels and when play game, player can take hint
...
function levelSelector() {
  ...
  if (level.toLowerCase() === "easy" || level.toLowerCase() === "es"){
    level = 3;
    console.log(`\nYou choose easy level - guess a ${level} digit number!!Good luck ${UserName}`);
  } else if (level.toLowerCase() === "medium" || level.toLowerCase() === "m") {
    level = 4;
    console.log(`\nYou choose medium level - guess a ${level} digit number!!Good luck ${UserName}`);
  } else if (level.toLowerCase() === "hard" || level.toLowerCase() === "h"){
    level = 5;
    console.log(`\nYou choose hard level - guess a ${level} digit number!!Good luck ${UserName}`);
  } else if (level.toLowerCase() === "extreme" || level.toLowerCase() === "ex"){
    level = 6;
    console.log(`\nYou choose extreme level - guess a ${level} digit number!!you are brave ${UserName}`);
  } else {
    level = false;
    console.log(
...
function playTheGame(level) {
  ...
  let totalGames = 0; // Track the number of games played
  let guessedDigits = [];
