...
// }
Array(10) creates an array of length 10. However, this array is empty, meaning it does not have any values in it.
.keys() is a method available on arrays which returns an iterator that produces the keys (indices) of the array. In this case, it will produce the keys 0 through 9.
