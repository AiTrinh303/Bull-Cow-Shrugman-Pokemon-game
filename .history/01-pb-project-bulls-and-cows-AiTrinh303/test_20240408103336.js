...
function levelSelector() {
  ...
  switch (userInput.toLowerCase()) {
    ...
    case "es+":
      ...
      console.log(`\nEasy+ level: Guess a ${level}-digit number! You have ${levelArray[1]} attempts. Good luck!`);
      break;
    ...
    case "m+":
      ...
      console.log(`\nMedium+ level: Guess a ${level}-digit number! You have ${levelArray[1]} attempts. Good luck!`);
      break;
    ...
    case "h+":
      ...
      console.log(`\nHard+ level: Guess a ${level}-digit number! You have ${levelArray[1]} attempts. Good luck!`);
      break;
    ...
    case "ex+":
      ...
      console.log(`\nExtreme+ level: Guess a ${level}-digit number! You have ${levelArray[1]} attempts. Good luck!`);
      break;
