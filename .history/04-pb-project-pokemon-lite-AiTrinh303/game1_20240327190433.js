...
//========================================================================================================
//Task: find the strongest Pokemon of all Pokemons
function findStrongestPokemon(array) {
    let strongestPokemon = newPokemons[0];
    for (let i = 1; i < newPokemons.length; i++) {
      if (newPokemons[i].magic > strongestPokemon.magic) {
        strongestPokemon = newPokemons[i];
      }
    }
