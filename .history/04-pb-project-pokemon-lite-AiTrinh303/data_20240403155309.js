...
function createRandomPokemon() {
    ...
    const randomHealth = Math.floor(Math.random() * (300 - 100 + 1)) + 100; // Random health from 100 to 300   
    const randomMagic = Math.floor(Math.random() * (150 - 50 + 1) + 50; // Random magic from 50 to 150
