...
function countAllWins() {
  ...
  // After all battles are done, print the number of wins for each Pokemon
...
//find the Pokemon with the most wins
const mostWins = newPokemons.reduce((acc, curr) => {
  return acc.wins > curr.wins ? acc : curr;
});

console.log(`The Pokemon with the most wins is: ${mostWins.name} with ${mostWins.wins} wins.`);